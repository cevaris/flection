...
object StockSpec extends TestSpec {
  def genStock(base: Int, minusDays: Int, growth: Double): Stock = {
    ...
    Stock(datetime.toInstant, Price(base + (minusDays * growth)))
  }

  val genStocksDowntrend = (0 until 365) map (i => genStock(50, i, -0.1))
  val genStocksFlatline = (0 until 365) map (i => genStock(50, i, 0.0))
  val genStocksUptrend = (0 until 365) map (i => genStock(50, i, 0.1))
